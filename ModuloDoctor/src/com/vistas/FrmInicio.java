...
public class FrmInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCerrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/user.png"))); // NOI18N
        ...
        btnCerrar.setBounds(350, 10, 190, 50);
        ...
        jLabel4.setBounds(220, 20, 70, 20);
        ...
        BtnRolesUs1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/salir.png"))); // NOI18N
        ...
        BtnRolesUs1.setBounds(550, 10, 140, 50);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(variable==0){
            ...
            this.dispose();
            diag.setIdExp(Integer.parseInt(FrmInicio.jTable1.getValueAt(fila, 0).toString()));
            diag.setDescripcion("");
            diag.setPresion("");
            diag.setAltura("");
            diag.setPeso("");
